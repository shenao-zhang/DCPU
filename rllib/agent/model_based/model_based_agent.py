...
class ModelBasedAgent(AbstractAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.policy = policy
        self.q_updating = policy_learning_algorithm.q_updating
...
#        )
        self.initial_states_dataset = initial_states_dataset
    ...
    def act(self, state):
        ...
        #    print(self.policy.nn.hidden_layers[0].weight.data, 'policy ref real action')  # TODO
...
#            self.dynamical_model.sample_posterior()
    ...
    def learn(self, memory=None):
        ...
        def closure1():
            ...
            losses = self.algorithm(observation.clone(), ref_policy=False)
        ...
        def closure2():
            ...
            losses = self.algorithm(observation.clone(), ref_policy=True)
            losses.combined_loss.mean().backward()
        ...
        with DisableGradient(
            ...
            self._learn_steps(closure1, closure2)
