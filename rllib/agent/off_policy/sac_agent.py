...
class SACAgent(OffPolicyAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.q1_updating = self.algorithm.q1_updating
        self.q2_updating = self.algorithm.q2_updating
        self.q3_updating = self.algorithm.q3_updating
        self.q4_updating = self.algorithm.q4_updating
        self.q5_updating = self.algorithm.q5_updating
        self.q_list = self.algorithm.q_list
