...
class KLLoss(nn.Module):
    ...
    def __init__(self, epsilon_mean=0.0, epsilon_var=0.0, regularization=False, ref_policy=True):
        super().__init__()
        if epsilon_var is None or epsilon_var == 0.0:
